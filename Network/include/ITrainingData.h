...
template <typename T> class ITrainingData
{
public:
    ...
    virtual void GetNextInputAndTargetValues(std::vector<T>* inputs,
                                             std::vector<T>* targets) = 0;
    virtual unsigned GetNumberOfInputs() const
    {
        return m_numOfInputs;
    }
    virtual unsigned GetNumberOfTargets() const
    {
        return m_numOfTargets;
    }
